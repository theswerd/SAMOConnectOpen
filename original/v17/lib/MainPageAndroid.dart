...
import 'package:v17/newsFeed.dart';
...
IconButton infoButton() {
  return IconButton(
    ...
    onPressed: (){
      ...
      }else if(currentIndex==11/*ASB EVENT FEED*/){
        Constants.showInfoBottomSheet(
          [
            CupertinoActionSheetAction(
      ...
      CupertinoAlertDialog showSignUpOrLoginDialog() {
        ...
        checkUpdate(DocumentSnapshot currentUpdate) => currentUpdate.data["iOSupdate"]>5.02;
                   ...
                   return Scaffold(
                     ...
                     bottomNavigationBar: TabBar(
                       ...
                       tabs: <Widget>[
                        ...
                        //  Tab(          
                        //    icon: Icon(MdiIcons.home, color: Colors.black,),
                        //  ),
                         Tab(
