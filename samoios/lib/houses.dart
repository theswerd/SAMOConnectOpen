      ...
      body: FutureBuilder(
        ...
        builder: (c,s){
          ...
          if(s.connectionState!=ConnectionState.done){
            ...
            print("TEST 12");
            //print(overallbody[3].text);
            List<dom.Element> teachers;
            try {
              teachers = overallbody[3].children[1].children[0].children[0].children.last.children;
            ...
            //print(overallbody[3].children.length);
            //print(overallbody[3].children[1].children[0].children[0].children.last.children.length);
            teachers.removeAt(1);

            List<dom.Element> admin;
            try {
              admin = overallbody[2].children[1].children[0].children[0].children[0].children;
           ...
           //List<dom.Element> teachers = overallbody[3].children[1].children[0].children[0].children.last.children;
            ...
            List<dom.Element> allTeachers = teachers[0].children[0].children[0].children+teachers.last.children[0].children[0].children;
            ...
            try {
              ...
              print("ERROR IN DA TEACHERS");
              print(e);
            }
          Widget departmentslistView = Center(child: Text("Handshake Failure"),);
           try {
            departmentslistView = ListView.separated(
            ...
            return Scaffold(
              ...
              print(e);
              return Center(child: Text("HTML Handshake Failure"),);
            }
                 }}
          ));
