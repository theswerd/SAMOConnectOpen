...
class _IlluminateState extends State<Illuminate> with TickerProviderStateMixin {
  ...
  FutureBuilder<http.Response> loginPage() {
    return FutureBuilder(
      ...
      builder: (c, s) {
        if (s.hasError) {
          return Center(
            child: Text("Network Handshake Error;\nCheck your connection"),
          );
        }
            ...
            IconButton(
              ...
              onPressed: () {
                Constants.showInfoBottomSheet([
                  ...
                  CupertinoActionSheetAction(
                    ...
                    onPressed: () => showCupertinoModalPopup(
                        ...
                        builder: (c) => CupertinoAlertDialog(
                              ...
                              content: Text(
                                  "In-app illuminate makes accessing your gradebook easy. Your information completely safe, it is only used for when you login, and cleared when you press the back button."),
                              actions: <Widget>[
                  ...
                  CupertinoActionSheetAction(
                    child: Text("Share"),
                    onPressed: () => Constants.shareString(
                        "Hate using illuminate on your phone? SAMOHI Connect offers a true, formatted, in-app illuminate experience -- https://swerd.tech/samoconnect.html"),
                  )
                ], context);
              },
            )
  ...
  FutureBuilder<http.Response> checkLogin(
      String header, String username, String password) {
    return FutureBuilder(
      future: http.post(baseURL + "/login_check",
    ...
    try {
      return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
            child: AnimatedIcon(
                icon: AnimatedIcons.menu_close, progress: menuController),
            heroTag: "Menu",
            onPressed: () {
        ...
        body: FutureBuilder(
          future: http.get(baseURL + "/student-path?login=1",
              headers: {"cookie": header}),
          builder: (c, s) {
            if (s.connectionState != ConnectionState.done) {
              return Column(
  ...
  FutureBuilder<http.Response> gradebookBuilder(String header) {
    try {
      return FutureBuilder(
          future:
              http.get(baseURL + "/gradebooks/", headers: {"cookie": header}),
          builder: (c, s) {
            if (s.connectionState != ConnectionState.done) {
              return Column(
                mainAxisAlignment: MainAxisAlignment.center,
              ...
              try {
                ...
                for (dom.Element grade in unformattedGrades) {
                  ...
                  classMap['grade'] =
                      grade.children.first.innerHtml.split(" ").first;
                  ...
                  try {
                    gradePercent = double.parse(grade.children.first.innerHtml
                        .split(" ")
                        .last
                        .split('%')
                        .first
                  ...
                  classMap['url'] =
                      grade.children[2].children.first.attributes['href'];
                ...
                officialWebsiteAction = new CupertinoActionSheetAction(
                    ...
                    onPressed: () => gradebookWebview(
                        header, baseURL + "/gradebooks/", "Gradebook"));
                return Scaffold(
                  appBar: TabBar(
                        ...
                        itemBuilder: (c, i) {
                          ...
                          Row theClassHeading = Row(
                            ...
                            children: <Widget>[
                              ...
                              Text(thisClass['grade'],
                                  style: TextStyle(
                                      color: thisClass['gradeColor'],
                          ...
                          return RaisedButton(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                AnimatedCircularChart(
                                  ...
                                  holeLabel: formattedGrades[i]['gradePercent']
                                          .toString() +
                                      "%",
                                  ...
                                  initialChartData: [
                                    CircularStackEntry([
                                      CircularSegmentEntry(
                                          formattedGrades[i]['gradePercent'],
                            ...
                            onPressed: () => openClassGradebook(
                                header,
                                formattedGrades[i]['url'],
                                formattedGrades[i]['class']),
                          );
                        },
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  Text(
                                    formattedGrades[i]['teacher'],
                                    style: TextStyle(
                                        fontSize: 19,
                                        fontWeight: FontWeight.normal,
                                        color: Colors.grey[600]),
                                  ),
                                  Text(formattedGrades[i]['lastUpdated'],
                                      style: TextStyle(
                                          fontSize: 19,
                                          fontWeight: FontWeight.bold))
                                ],
                                      ...
                                      for (Map assignment in theAssignments) {
                                        try {
                                          ...
                                          if (assignment['missing']) {
                                            infoAnalysis['missings'] != null
                                                ? infoAnalysis['missings']++
                                                : infoAnalysis['missings'] = 1;
                                            infoAnalysis['hasMissings'] = true;
                                            print("WE HAVE A MISSING");
                                          } else if (assignment['ace']) {
                                            infoAnalysis['aces'] != null
                                                ? infoAnalysis['aces']++
                                                : infoAnalysis['aces'] = 1;
                                        ...
                                        missingWidget = Column(
                                          children: <Widget>[
                                            FloatingActionButton(
                                              ...
                                              tooltip: infoAnalysis['missings']
                                                      .toString() +
                                                  " Missing",
                                              heroTag: formattedGrades[i]
                                                  .toString() /*Stopping scheduler conflicts */,
                                            ),
                                            Text(infoAnalysis['missings']
                                                    .toString() +
                                                " Missing")
                                          ],
                                        );
                                        ...
                                        aceWidget = Column(
                                          children: <Widget>[
                                            FloatingActionButton(
                                              ...
                                              tooltip: infoAnalysis['aces']
                                                      .toString() +
                                                  " Aces",
                                              heroTag: formattedGrades[i]
                                                      .toString() +
                                                  "ACE" /*Stopping scheduler conflicts */,
                                            ),
                                            Text(infoAnalysis['aces']
                                                    .toString() +
                                                " Aces")
                                          ],
                                        );
              ...
              appBar: AppBar(
                ...
                actions: <Widget>[
                  IconButton(
                    icon: Icon(Icons.launch),
                    onPressed: () =>
                        gradebookWebview(header, baseURL + url, "Gradebook"),
                  )
                ],
              ),
              body: FutureBuilder(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Row(
                                ...
                                children: <Widget>[
                                  Text(
                                    theAssignmentsF[i]['name'],
                                    style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold),
                                  ),
                                  Text(
                                    theAssignmentsF[i]['points'],
                                    style: TextStyle(
                                        fontSize: 21,
                                        fontWeight: FontWeight.normal),
                                  ),
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    children: <Widget>[
                                      theAssignmentsF[i]['extraCredit']
                                          ? FloatingActionButton(
                                              backgroundColor:
                                                  Constants.baseColor,
                                              onPressed: () {},
                                              tooltip: "Extra Credit!",
                                              child:
                                                  Icon(MdiIcons.thumbUpOutline),
                                              mini: true,
                                            )
                                          : Container(),
                                      !theAssignmentsF[i]['graded']
                                          ? FloatingActionButton(
                                              backgroundColor:
                                                  Colors.cyanAccent,
                                              onPressed: () {},
  ...
  attendanceBuilder(String header) async {
    Widget attendanceBody = FutureBuilder(
      future: http
          .get(baseURL + "/attendance/summary", headers: {"cookie": header}),
      builder: (c, s) {
        if (s.hasError) {
          return Column(
            mainAxisAlignment: MainAxisAlignment.center,
        ...
        if (s.connectionState != ConnectionState.done) {
          ...
          try {
            ...
            List<dom.Element> recordsUnF = attendanceDoc
            ...
            for (dom.Element recordsUnF in recordsUnF) {
              ...
              try {
                ...
                newMap['totalAD'] =
                    double.parse(recordsUnF.children[1].text.trim());
                newMap['percentAD'] = recordsUnF.children[2].text.trim();
                newMap['totalC'] =
                    double.parse(recordsUnF.children[3].text.trim());
                newMap['percentC'] = recordsUnF.children[4].text.trim();
                if (newMap['category'] == "On Time" ||
                    newMap['category'] == "Tardy" ||
                    newMap['category'] == "Excused" ||
                    newMap['category'] == "Unexcused") {
                  format.add(newMap);
                }
              } catch (e) {}
            }
            ...
            for (Map item in format) {
              segmentsAllDay
                  .add(CircularSegmentEntry(item['totalAD'], item['color']));
              segmentsClasses
                  .add(CircularSegmentEntry(item['totalC'], item['color']));
            }
            ...
            return Center(
                child: Text(
                    "Sorry, we couldn't proccess your attendance records"));
          }
        }
      },
    );
              ...
              appBar: AppBar(
                ...
                actions: <Widget>[
                  IconButton(
                    ...
                    onPressed: () => gradebookWebview(
                        header, baseURL + "/attendance/summary", "Attendance"),
                  ),
                ],
              ),
              body: attendanceBody)));
  ...
  Row attendanceRawDataRowMaker(Map format) {
    return Row(
      children: <Widget>[
        Text(format['category'].toString(),
            style: TextStyle(fontWeight: FontWeight.bold)),
        VerticalDivider(),
        Text(format['totalC'].toInt().toString() + " Times"),
        VerticalDivider(),
        Text(format['percentC'].toString().split("%").first.trim() +
            "% of the time"),
      ],
    );
  }
